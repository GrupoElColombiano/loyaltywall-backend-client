        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (userDto.password !== userDto.confirmPassword) {
                    throw new common_1.NotFoundException('Las contraseñas no coinciden');
                }
                const { password, confirmPassword } = userDto;
                const passwordHashed = yield (0, hash_password_1.hashPassword)(password);
                const confirmPasswordHashed = yield (0, hash_password_1.hashPassword)(confirmPassword);
                const userWithHashedPassword = Object.assign(Object.assign({}, userDto), { password: passwordHashed, confirmPassword: confirmPasswordHashed });
                console.log('usuario completo', userWithHashedPassword);
                yield this.userRepository.save(userWithHashedPassword);
                return {
    ...
    deleteUser(email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.userRepository.delete({ email });
                return {
