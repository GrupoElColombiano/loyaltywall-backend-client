...
const payment_entity_entity_1 = require("../../payment/entity/payment.entity.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => payment_entity_entity_1.PaymentGateway),
...
], PaymentTransaction.prototype, "userName", void 0);
__decorate([
    (0, typeorm_1.Column)(),
